...
public class QueryConstants {
    ...
    public static final String CREATE_USER_QUERY="create table user(id int,name varchar(25),mailid varchar(35),address varchar(100),mobileno varchar(13),licence varchar(20))";
    ...
    public static final String INSERT_USER_QUERY="insert into user(id,name,mailid,address,mobileno,licence) values(?,?,?,?,?,?)";
    public static final String UPDATE_ADMIN_QUERY="update admin set name=?, mailid=?,address=?,mobile=?,experiance=?,salary=? where id=?";
    public static final String UPDATE_USER_QUERY="update user set name=?, mailid=?, address=?, mobileno=?, licence=? where id=?";
